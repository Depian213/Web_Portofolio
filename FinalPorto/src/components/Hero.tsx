    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-[#D6F4ED] via-[#87BAC3] to-[#53629E] bg-clip-text text-transparent animate-fade-in">
          lmaginer Developer and Engineer
        </h1>

        <p className="text-xl md:text-2xl text-gray-400 mb-8 max-w-2xl mx-auto">
          I craft digital experiences through programming and design
        </p>
        ...
        <div className="flex items-center justify-center gap-6">
          <a href="https://github.com/Depian213" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#87BAC3] transition-colors duration-300">
            <Github size={24} />
          </a>
          <a href="www.linkedin.com/in/debian-bifano-putra-gegana-a31363359" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#87BAC3] transition-colors duration-300">
            <Linkedin size={24} />
          </a>
          <a href="mailto:dbifanoputragegana@gmail.com" className="text-gray-400 hover:text-[#87BAC3] transition-colors duration-300">
            <Mail size={24} />
          </a>
        </div>
      </div>
