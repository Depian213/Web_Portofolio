  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-20">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <article>
          <div
  className="h-96 rounded-3xl mb-12 border border-[#473472]/30 bg-center bg-cover"
  style={{
    backgroundImage: article.cover_image
      ? `url(${article.cover_image})`
      : 'linear-gradient(135deg, #87BAC3cc, #53629Ecc)',
  }}
/>
          ...
          <div className="p-8 bg-gradient-to-br from-[#473472]/20 to-[#53629E]/20 rounded-2xl border border-[#87BAC3]/30">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-white font-semibold">Written by Debian Bifano</p>
